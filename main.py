...
from model import ConvolutionDiscriminator, ConvolutionGenerator, LinearDiscriminator, LinearGenerator, ModelConfig
...
if __name__ == '__main__':
    ...
    generator = ConvolutionGenerator(mconf)
    discriminator = ConvolutionDiscriminator(mconf)
